    ...
    return (
      <div className="mx-auto max-w-md space-y-4 p-8 text-center">
        <h2 className="font-display text-2xl font-bold text-leaf-950">
          {t.sms?.title || "SMS Gateway Simulator"}
        </h2>

        <p className="text-sm text-soil-900/70">
          {t.sms?.loginMessage ||
            "Log in as a farmer to simulate SMS messages and receive crop price information."}
        </p>
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      <div className="mb-4">
        ...
        >
          <ArrowLeft size={14} />
          {t.sms?.backDashboard || "Back to Dashboard"}
        </button>
      </div>
