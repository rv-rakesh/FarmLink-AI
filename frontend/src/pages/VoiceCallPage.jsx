  ...
  if (!user || user.role !== "farmer") {
    return (
      <div className="mx-auto max-w-md p-8 text-center space-y-4">
        <h2 className="font-display text-2xl font-bold text-leaf-950">Voice Helpline Simulator</h2>
        <p className="text-sm text-soil-900/70">
          To simulate the interactive voice call session and receive fair pricing recommendations, please log in as a farmer.
        </p>
        <button
